...
<html>
<head>
	<title>GPW Washim</title>
	<link rel="shortcut icon" href="./Images/gpw 4.jpg" type="image/x-icon">
...
<nav class="navbar navbar-expand-lg navbar-dark header-back sticky-top header-navbar-fonts">
	<a class="navbar-brand d-flex align-items-center" href="index.php">
		<img src="Images\gpw 4.jpg" class="logo-image" width="50" height="50">
		<h3 class="text-light text-uppercase ml-2">GPW</h3>
	</a>
